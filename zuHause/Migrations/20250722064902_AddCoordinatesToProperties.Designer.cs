...
namespace zuHause.Migrations
{
    ...
    [Migration("20250722064902_AddCoordinatesToProperties")]
    partial class AddCoordinatesToProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("zuHause.Models.GoogleMapsApiUsage", b =>
                {
                    b.Property<int>("GoogleMapsApiId")
                        ...
                        .HasComment("Google Maps API 使用量ID");
                    ...
                    b.HasKey("GoogleMapsApiId")
                        .HasName("PK_GoogleMapsApiUsage");

                    b.ToTable("GoogleMapsApiUsage", null, t =>
                        {
                            t.HasComment("Google Maps API 使用量追蹤表");
                        });
                });
