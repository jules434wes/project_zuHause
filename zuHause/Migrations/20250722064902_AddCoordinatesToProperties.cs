...
{
    /// <inheritdoc />
    public partial class AddCoordinatesToProperties : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    googleMapsApiId = table.Column<int>(type: "int", nullable: false, comment: "Google Maps API 使用量ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    apiType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "API 類型"),
                    requestDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "請求日期"),
                    requestCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "當日請求次數"),
                    estimatedCost = table.Column<decimal>(type: "decimal(10,4)", nullable: false, defaultValue: 0m, comment: "預估成本"),
                    isLimitReached = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "是否達到限制"),
                ...
                comment: "Google Maps API 使用量追蹤表");
